...
namespace DE.Onnen.Sudoku
{
	...
	public class CellTest
	{
		...
		public void Digit_set_Digit_removes_Candidates_in_Houses()
		{
			...
			target.fieldcontainters[0] = new HouseCollection(row, HouseType.Row, 1);
			target.fieldcontainters[1] = new HouseCollection(col, HouseType.Col, 1);
			target.fieldcontainters[2] = new HouseCollection(box, HouseType.Box, 1);
